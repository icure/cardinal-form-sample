...
exports.IcureButtonGroup = void 0;
...
class IcureButtonGroup extends (0, field_with_options_1.FieldWithOptionsMixin)(common_1.Field) {
    constructor() {
        super(...arguments);
        this.type = 'radio';
    }
    ...
    checkboxChange() {
        ...
        if (this.handleValueChanged) {
            const [valueId] = (_a = this.getValueFromProvider()) !== null && _a !== void 0 ? _a : '';
            const inputs = Array.from(((_b = this.shadowRoot) === null || _b === void 0 ? void 0 : _b.querySelectorAll('input')) || []).filter((input) => input.checked);
            const selectedOptions = (_c = this.displayedOptions) === null || _c === void 0 ? void 0 : _c.filter((option) => inputs.some((i) => i.id === option.id));
            (_d = this.handleValueChanged) === null || _d === void 0 ? void 0 : _d.call(this, this.label, this.language(), {
                content: {
                    [this.language()]: {
                        type: 'compound',
                        value: selectedOptions === null || selectedOptions === void 0 ? void 0 : selectedOptions.reduce((acc, c) => (Object.assign(Object.assign({}, acc), { [c.id]: { type: 'boolean', value: true } })), {}),
                    },
                },
    ...
    generateStyle() {
        ...
        return ((_a = this.styleOptions) === null || _a === void 0 ? void 0 : _a.span)
            ? `grid-template-columns: repeat(${(_b = this.styleOptions) === null || _b === void 0 ? void 0 : _b.span}, 1fr);`
            : ((_c = this.styleOptions) === null || _c === void 0 ? void 0 : _c.rows)
                ? `grid-template-columns: repeat(${Number(((_e = (_d = this.displayedOptions) === null || _d === void 0 ? void 0 : _d.length) !== null && _e !== void 0 ? _e : 0) / ((_f = this.styleOptions) === null || _f === void 0 ? void 0 : _f.rows))}, 1fr);`
                : '';
    }
}
